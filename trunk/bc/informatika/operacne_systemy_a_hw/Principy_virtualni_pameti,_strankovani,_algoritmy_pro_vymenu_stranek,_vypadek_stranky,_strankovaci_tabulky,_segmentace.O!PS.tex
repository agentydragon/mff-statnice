...
\subsubsection*{Segmentace (už není v požadavcích!!!)}
...
\end{verbatim}    
Pak byly zadány hodnoty (decimální) ukazatelù P a N. Dotaz byl jestli by se Mezi P a N vešel ještì jeden malloc o nìjaké velikosti.
NSD(P,N) = 16 ... popište èím by to mohlo být a proè.

Pak bylo ještì nìco s urèováním velikosti stránky z adresy 0xFF10, která zùstala na addr sbìrnici po dotazu na ukazatel na první byte prvního bloku. ? Výsledek ale souvisel s hodnotami toho P a N podle toho co Bednárek øíkal na ústní, takže to sem asi bude muset dát nìkdo kdo si to pamatuje lépe.
