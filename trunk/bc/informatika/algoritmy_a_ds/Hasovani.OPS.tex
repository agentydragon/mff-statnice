...
potøebovat položek pro práci s tabulkou a tedy vzroste pamìová nároènost. Naším
cílem je tedy najít rozumný kompromis mezi sofistikovaností (rychlostí)
strategie a její pamìovou nároèností. Podívejme se na další algoritmy,
které se o to pokoušejí.

\subsubsection*{Hašování s pøemísováním}
...
pøemístíme na jiný prázdný øádek v tabulce (proto hašování s pøemísováním).

\begin{e}{Algoritmus}{0}{Hašování s pøemísováním}
...
Hašování s pøemísováním má tu nevýhodu, že díky pøemisování prvkù jsou operace
...
Algoritmy jsou potom podobné tìm u hašování s pøemísováním, ale pøemísování
...
pøemísováním, ale zaèátek øetìzce v jiném øádku tabulky pøidá navíc jeden test,
...
\item Hašování se separovanými øetìzci = Hašování s pøemísováním,
...
\begin{penumerate}
\item H. s uspoøádanými øetìzci = H. se separovanými øetìzci = H. s pøemísováním,
\item Hašování se dvìma ukazateli,
\item VICH,
\item LICH,
\item EICH,
...
více pamìti. Metoda s pøemísováním vyžaduje více èasu -- na pøemístìní prvku.
...
Jeden z~takových systémù funkcí je napøíklad $h_{a,b}(x) = ((ax + b) \mod |U|) \mod m$, kde $a,b$ jsou náhodnì voleny.
...
\end{e}
\begin{e}{Report}{0}{Skopal} dostal mì na otázkách ohlednì hashovací fce - jaké jsou na ní kladené požadavky (nejsem si vìdom, že bychom to probírali tak podrobnì), hned se pak pøesunul k Univerzálnímu a Perfektnímu hashování - když jsem mu neøekl perfektní, tak se zvedl a øekl to staèí... a nezašli jsme ani ke kolizím, které jsem mìl vypracované (dostal jsem od nìj dílèí známku za 3).
