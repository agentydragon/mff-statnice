...
\begin{e} Dáno univerzum $U$, máme reprezentovat{Definice}{0}{slovníkový problém}
...
\begin{e} Funkci{Definice}{0}{Hašovací funkce, kolize}
...
\begin{e} Metody se separovanými øetìzci a srùstající hašování používají{Poznámka}{0}{0}
