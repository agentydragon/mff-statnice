%&latex
\subsection{Uzávìrové vlastnosti tøíd jazykù}

\begin{obecne}{Shrnutí\footnote{Zdroj: \url{http://en.wikipedia.org/wiki/Formal_language#Operations_on_languages}}}
\begin{center}
...
\begin{e}{Poznámka}{0}{Doplnìk RekJ musí vdy bıt RekJ}
