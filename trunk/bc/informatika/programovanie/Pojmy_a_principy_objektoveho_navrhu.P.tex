...
TODO: tohle je tupý copy \& paste z Wikipedie, pøedìlat/pøeložit

\begin{e}{Definice}{0}{Objektový návrh}
...
Objektový návrh poèítá s vlastnostmi objektového programování, podporovanými objektovì-orientovanými jazyky. Jsou to zejména:
\begin{pitemize}
    \item zapouzdøení, objekty
    \item abstrakce, skrytí informací
    \item dìdiènost
    \item vnìjší interface
    \item polymorfismus
\end{pitemize}
\end{e}

\begin{obecne}{Postup pøi objektovém návrhu / Designing concepts}
\begin{pitemize}
