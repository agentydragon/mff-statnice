...
\begin{prikladN}{srovnání RA, DRK, NRK}
...
\\\\
NRK:\\
$\{film[JMENO\_FILMU] \;|\; \forall herec(HEREC(herec) \Rightarrow

f(FILM(f) \wedge\; f.JMENO\_HERCE = herec.JMENO\_HERCE \;\wedge

f.JMENO\_FILMU = film.JMENO\_FILMU))\}$
\end{prikladN}
