...
pak 
\begin{verbatim}
   R = {(Novák, Hlavní, Harrison), (Starý, Severní, Rájec), (Coufal, Severní, Rájec), 
        (Liška, Sadová, Polná)}
\end{verbatim}
...
\begin{center}
\includegraphics[scale=0.5]{informatika/databazy/obrazky/kart_soucin}
...
\begin{center}
\includegraphics[scale=0.5]{informatika/databazy/obrazky/projekce}
...
$R_1 \cap R_2 = (R_1 \cup R_2 \setminus (R_1 \setminus R_2))\setminus (R_1 \setminus R_2)$
...
\begin{center}
\includegraphics[scale=0.5]{informatika/databazy/obrazky/natural_join}
\\ 
...
\\
–lze vyjádøit pomocí kartézského souèinu a projekce:
\\
$R \div S = R[A\setminus B] \setminus ((R[A\setminus B] \times S)\setminus
R)[A\setminus B]$

\begin{center}
\includegraphics[scale=0.5]{informatika/databazy/obrazky/deleni}
\\ 
pøíklad dìlení
\end{center}
\end{pitemize}
