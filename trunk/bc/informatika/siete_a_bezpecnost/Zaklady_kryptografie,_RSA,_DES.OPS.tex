...
\begin{definiceN}{Nahodné generátory}
...
\begin{definiceN}{Hashovaci funkce}
...
\begin{definiceN}{Model utocnika podle Doleva a Yao}
\begin{pitemize}
...
\\\\TODO
\end{priklad}
\begin{definiceN}{protokol Diffie-Hellman}
\begin{pitemize} 
