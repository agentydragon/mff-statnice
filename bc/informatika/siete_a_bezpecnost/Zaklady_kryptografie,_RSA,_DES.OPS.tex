\subsection{Základy kryptografie, RSA\sout{, DES}}

(nejsou zde uvedeny pøíklady symetrických šifer, pro zájemce veselý komiks o AES -- \url{http://www.moserware.com/2009/09/stick-figure-guide-to-advanced.html} :))

\subsubsection*{Základy kryptografie\footnote{sestaveno podle vrazedneho zkouseni Jaghobem}} 
\begin{e}{Definice}{1}{Kryptografický systém}
...
\begin{e}{Report}{0}{Skopal} RSA, DES (tady chtìl Skopal konkrétní vzoreèky, jak funguje symetrická šifra nebo šifrování s vìøejným klíèem ho nezájímalo)
\end{e}
