...
\begin{definiceN}{Architektura poèítaèa}
...
\begin{definiceN}{Víceúrovòová organizace poèítaèe}
\begin{pitemize}
...
\begin{prikladN}{Naèrtnìte typickou architekturu pocitace, ze které bude zrejmé umísténí a propojení základnich stavebních prvku (procesor, pameti, radice a zarízeni, sbenice). Ilustrujte na úrovni zakladnich krokù ínstrukcního cyklu jak procesor vykonává program. Popište typy instrukci (a napište jejich pøíklady), ze kterıch se program z pohledu procesoru skládá.}
\\
