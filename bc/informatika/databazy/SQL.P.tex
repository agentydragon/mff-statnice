...
\begin{penumerate}
    ...
    \item Zbylé øádky se seskupí do skupin se stejnými hodnotami uvedených výrazù (\texttt{GROUP BY}), každá skupina obsahuje atomické sloupce s hodnotami uvedených výrazù a množinové sloupce se skupinami ostatních hodnot sloupcù.
...
Tento pøíkaz slouží k vytvoøení nové tabulky. Je nutné definovat její název, atributy a jejich domény (datové typy); dále je možné definovat integritní omezení (klíèe, cizí klíèe, odkazy, podmínky). Pøíkaz vypadá následovnì:
\begin{center}
